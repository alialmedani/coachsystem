...
public class CoachAppDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        CoachAppGlobalFeatureConfigurator.Configure();
        CoachAppModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<CoachAppDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<CoachAppResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/CoachApp");

            options.DefaultResourceType = typeof(CoachAppResource);
        ...
        {
            options.MapCodeNamespace("CoachApp", typeof(CoachAppResource));
        });
    }
}
